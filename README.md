...
Проектная работа OTUS (Захаров Святослав). Кэш реализован на .NET 10, C# 12, с собственным бинарным TCP-протоколом, zero-allocation парсером на `Span<byte>`, source-gen сериализацией и наблюдаемостью через OpenTelemetry. 
